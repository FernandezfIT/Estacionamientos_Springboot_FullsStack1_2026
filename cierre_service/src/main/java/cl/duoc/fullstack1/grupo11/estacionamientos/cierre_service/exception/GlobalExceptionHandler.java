...
import cl.duoc.fullstack1.grupo11.estacionamientos.cierre_service.dto.response.ErrorResponse;
import jakarta.servlet.http.HttpServletRequest;

@RestControllerAdvice
public class GlobalExceptionHandler {

    @ExceptionHandler(CierreNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarCierreNoEncontrado(
            CierreNoEncontradoException ex,
    ...
    @ExceptionHandler(CierreEjecucionException.class)
    public ResponseEntity<ErrorResponse> manejarErrorEjecucionCierre(
            CierreEjecucionException ex,
            HttpServletRequest request
    ) {
        ErrorResponse errorResponse = construirErrorResponse(
                HttpStatus.CONFLICT,
    ...
    public ResponseEntity<ErrorResponse> manejarErrorGeneral(
        ...
        ErrorResponse errorResponse = construirErrorResponse(
                ...
                "Ocurrió un error interno en cierre_service",
                request.getRequestURI()
        );

...
import cl.duoc.fullstack1.grupo11.estacionamientos.vehiculo_service.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/tipos-vehiculos/**")
                        .hasAnyAuthority(JEFE_SEGURIDAD, JEFE_SSDD, GUARDIA)

                        // Consulta de vehículos
                        .requestMatchers(HttpMethod.GET, "/api/v1/vehiculos/**")
                        .hasAnyAuthority(JEFE_SEGURIDAD, JEFE_SSDD, GUARDIA)

                        // Creación de vehículos
                        .requestMatchers(HttpMethod.POST, "/api/v1/vehiculos/**")
                        .hasAnyAuthority(JEFE_SEGURIDAD, JEFE_SSDD)

                        // Actualización de vehículos
                        .requestMatchers(HttpMethod.PUT, "/api/v1/vehiculos/**")
                        .hasAnyAuthority(JEFE_SEGURIDAD, JEFE_SSDD)

                        // Eliminación de vehículos
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/vehiculos/**")
                        .hasAnyAuthority(JEFE_SEGURIDAD, JEFE_SSDD)

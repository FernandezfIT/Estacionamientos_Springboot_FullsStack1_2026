...
import cl.duoc.fullstack1.grupo11.estacionamientos.vehiculo_service.dto.response.ErrorResponse;
import jakarta.servlet.http.HttpServletRequest;

@RestControllerAdvice
public class GlobalExceptionHandler {

    @ExceptionHandler(VehiculoNoEncontradoEx.class)
    public ResponseEntity<ErrorResponse> manejarVehiculoNoEncontrado(
            VehiculoNoEncontradoEx ex,
    ...
    @ExceptionHandler(TipoVehiculoNoEncontradoEx.class)
    public ResponseEntity<ErrorResponse> manejarTipoVehiculoNoEncontrado(
            TipoVehiculoNoEncontradoEx ex,
            HttpServletRequest request
    ) {
        ErrorResponse errorResponse = construirErrorResponse(
                HttpStatus.NOT_FOUND,
    ...
    @ExceptionHandler(UsuarioNoEncontradoEx.class)
    public ResponseEntity<ErrorResponse> manejarUsuarioNoEncontrado(
            UsuarioNoEncontradoEx ex,
            HttpServletRequest request
    ) {
        ErrorResponse errorResponse = construirErrorResponse(
                HttpStatus.NOT_FOUND,
    ...
    @ExceptionHandler(RecursoDuplicadoEx.class)
    public ResponseEntity<ErrorResponse> manejarRecursoDuplicado(
            RecursoDuplicadoEx ex,
            HttpServletRequest request
    ) {
        ErrorResponse errorResponse = construirErrorResponse(
                HttpStatus.CONFLICT,
    ...
    public ResponseEntity<ErrorResponse> manejarErrorGeneral(
        ...
        ErrorResponse errorResponse = construirErrorResponse(
                ...
                "Ocurrió un error interno en vehiculo_service",
                request.getRequestURI()
        );

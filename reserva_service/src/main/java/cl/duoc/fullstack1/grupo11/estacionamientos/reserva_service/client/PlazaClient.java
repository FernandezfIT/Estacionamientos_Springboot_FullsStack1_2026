package cl.duoc.fullstack1.grupo11.estacionamientos.reserva_service.client;
...
public class PlazaClient {
    ...
    public PlazaResponse obtenerPlaza(Long idPlaza) {
        try {
    ...
    public PlazaResponse actualizarEstadoPlaza(Long idPlaza, String estado) {
        try {
